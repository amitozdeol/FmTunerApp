...
/**
 * This class is a part of a library found at this link:
 * http://androidtrainningcenter.blogspot.com/2012/08/date-time-picker-in-android.html
 * 
 * Class is copy-pasted into this project since the entire 'library' consists of just one
 * java file. (Makes the project setup cleaner). All credit (this class) goes to the author 
 * mentioned here ↓
 * @author Tofeeq Ahmad
 */
