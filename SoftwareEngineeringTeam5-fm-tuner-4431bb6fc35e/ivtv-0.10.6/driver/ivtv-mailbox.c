...
#define API_NO_WAIT 	 (1 << 4)	/* Command may not wait for a free mailbox */
...
static const struct ivtv_api_info api_info[256] = {
	...
	API_ENTRY(CX2341X_ENC_REFRESH_INPUT, 		API_NO_WAIT | API_HIGH_VOL),
	...
	API_ENTRY(CX2341X_ENC_UNKNOWN, 			API_FAST_RESULT),
